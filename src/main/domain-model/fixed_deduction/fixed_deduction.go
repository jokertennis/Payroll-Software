...
func NewFixedDeduction(id uint32, amount int, nominal string, fixedDeductionDetails []fixed_deduction_detail_domain_model.FixedDeductionDetail) (*FixedDeduction, error) {
