...
func createDataForTestOfGetSalaryStatementForEmployeeHandler(ctx context.Context, db boil.ContextExecutor) error {
	...
	salary_statements := []models.SalaryStatement{
		...
		{ID: 2, EarningID: 2, DeductionID: 2, EmployeeID: 2, Nominal: "2022年1月 給与明細", Payday: time.Date(2022, 1, 20, 0, 0, 0, 0, time.Local), TargetPeriod: "2022年12月1日~2022年11月31日"},
		{ID: 3, EarningID: 1, DeductionID: 1, EmployeeID: 1, Nominal: "2022年2月 給与明細", Payday: time.Date(2022, 2, 20, 0, 0, 0, 0, time.Local), TargetPeriod: "2022年1月1日~2022年1月31日"},
		{ID: 4, EarningID: 2, DeductionID: 2, EmployeeID: 2, Nominal: "2022年2月 給与明細", Payday: time.Date(2022, 2, 20, 0, 0, 0, 0, time.Local), TargetPeriod: "2022年1月1日~2022年1月31日"},
		{ID: 5, EarningID: 1, DeductionID: 1, EmployeeID: 5, Nominal: "2022年2月 給与明細", Payday: time.Date(2022, 2, 20, 0, 0, 0, 0, time.Local), TargetPeriod: "2022年1月1日~2022年1月31日"},
		{ID: 6, EarningID: 2, DeductionID: 2, EmployeeID: 5, Nominal: "2022年2月 給与明細", Payday: time.Date(2022, 2, 20, 0, 0, 0, 0, time.Local), TargetPeriod: "2022年1月1日~2022年1月31日"},
	}
...
func TestGetSalaryStatementForEmployeeHandler(t *testing.T) {
	cases := map[string]struct {
		...
		"success to get salary statement by employee": {
