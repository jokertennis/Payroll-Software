...
func (o *SalaryStatement) FixedEarning(mods ...qm.QueryMod) fixedEarningQuery {
	queryMods := []qm.QueryMod{
...
func (o *SalaryStatement) FixedDeduction(mods ...qm.QueryMod) fixedDeductionQuery {
	queryMods := []qm.QueryMod{
...
// loaded structs of the objects. This is for an N-1 relationship.
func (salaryStatementL) LoadFixedEarning(ctx context.Context, e boil.ContextExecutor, singular bool, maybeSalaryStatement interface{}, mods queries.Applicator) error {
	var slice []*SalaryStatement
	var object *SalaryStatement
	...
	if singular {
		...
		if !queries.IsNil(object.FixedEarningID) {
	...
	Outer:
		for _, obj := range slice {
			...
			for _, a := range args {
				if queries.Equal(a, obj.FixedEarningID) {
					continue Outer
				}
			}

			if !queries.IsNil(obj.FixedEarningID) {
	...
	for _, local := range slice {
		for _, foreign := range resultSlice {
			if queries.Equal(local.FixedEarningID, foreign.ID) {
...
// loaded structs of the objects. This is for an N-1 relationship.
func (salaryStatementL) LoadFixedDeduction(ctx context.Context, e boil.ContextExecutor, singular bool, maybeSalaryStatement interface{}, mods queries.Applicator) error {
	var slice []*SalaryStatement
	var object *SalaryStatement
	...
	if singular {
		...
		if !queries.IsNil(object.FixedDeductionID) {
	...
	Outer:
		for _, obj := range slice {
			...
			for _, a := range args {
				if queries.Equal(a, obj.FixedDeductionID) {
					continue Outer
				}
			}

			if !queries.IsNil(obj.FixedDeductionID) {
	...
	for _, local := range slice {
		for _, foreign := range resultSlice {
			if queries.Equal(local.FixedDeductionID, foreign.ID) {
...
func (o *SalaryStatement) RemoveIndividualEarning(ctx context.Context, exec boil.ContextExecutor, related *IndividualEarning) error {
	...
	related.R.SalaryStatement = nil
	return nil
}

// SetFixedEarning of the salaryStatement to the related item.
// Sets o.R.FixedEarning to related.
// Adds o to related.R.SalaryStatements.
func (o *SalaryStatement) SetFixedEarning(ctx context.Context, exec boil.ContextExecutor, insert bool, related *FixedEarning) error {
	var err error
	if insert {
		if err = related.Insert(ctx, exec, boil.Infer()); err != nil {
			return errors.Wrap(err, "failed to insert into foreign table")
	...
	queries.Assign(&o.FixedEarningID, related.ID)
	if o.R == nil {
		o.R = &salaryStatementR{
...
// RemoveFixedEarning relationship.
// Sets o.R.FixedEarning to nil.
// Removes o from all passed in related items' relationships struct.
func (o *SalaryStatement) RemoveFixedEarning(ctx context.Context, exec boil.ContextExecutor, related *FixedEarning) error {
	var err error

	queries.SetScanner(&o.FixedEarningID, nil)
	if _, err = o.Update(ctx, exec, boil.Whitelist("fixed_earning_id")); err != nil {
		return errors.Wrap(err, "failed to update local table")
	}

	if o.R != nil {
		o.R.FixedEarning = nil
	}
	if related == nil || related.R == nil {
		return nil
	}
	...
	for i, ri := range related.R.SalaryStatements {
		if queries.Equal(o.FixedEarningID, ri.FixedEarningID) {
			continue
		}
...
// SetFixedDeduction of the salaryStatement to the related item.
// Sets o.R.FixedDeduction to related.
// Adds o to related.R.SalaryStatements.
func (o *SalaryStatement) SetFixedDeduction(ctx context.Context, exec boil.ContextExecutor, insert bool, related *FixedDeduction) error {
	var err error
	if insert {
		if err = related.Insert(ctx, exec, boil.Infer()); err != nil {
			return errors.Wrap(err, "failed to insert into foreign table")
	...
	queries.Assign(&o.FixedDeductionID, related.ID)
	if o.R == nil {
		o.R = &salaryStatementR{
...
// RemoveFixedDeduction relationship.
// Sets o.R.FixedDeduction to nil.
// Removes o from all passed in related items' relationships struct.
func (o *SalaryStatement) RemoveFixedDeduction(ctx context.Context, exec boil.ContextExecutor, related *FixedDeduction) error {
	var err error

	queries.SetScanner(&o.FixedDeductionID, nil)
	if _, err = o.Update(ctx, exec, boil.Whitelist("fixed_deduction_id")); err != nil {
		return errors.Wrap(err, "failed to update local table")
	}

	if o.R != nil {
		o.R.FixedDeduction = nil
	}
	if related == nil || related.R == nil {
		return nil
	}
	...
	for i, ri := range related.R.SalaryStatements {
		if queries.Equal(o.FixedDeductionID, ri.FixedDeductionID) {
			continue
		}
