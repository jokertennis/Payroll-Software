...
var (
	salaryStatementDBTypes = map[string]string{`ID`: `mediumint`, `EarningID`: `mediumint`, `DeductionID`: `mediumint`, `EmployeeID`: `mediumint`, `Nominal`: `varchar`, `Payday`: `date`, `TargetPeriod`: `varchar`, `CreatedAt`: `timestamp`, `UpdatedAt`: `timestamp`}
	_                      = bytes.MinRead
)
